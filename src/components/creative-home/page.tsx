...
export default function Home(){
 ...
 return <div className="creative-home"><link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500&family=Inter:wght@400;500;600;700;800&display=swap" /><ParticleBackground/><Motion/><a className="skip-link" href="#main">ข้ามไปเนื้อหา</a>
 <SiteHeader/>
