      ...
      <div className="mx-auto max-w-[1440px] px-5 py-14 sm:px-8 lg:px-12 lg:py-20">
        <div className="grid gap-12 border-b border-white/10 pb-14 md:grid-cols-2 lg:grid-cols-12">
          <div className="lg:col-span-5">
            <Link href="/v2" className="inline-flex items-center gap-3 text-3xl font-black tracking-[-0.045em]"><BrandLogo iconSize={38} logoUrl={logoUrl} siteName={siteName} wrapperClassName="inline-flex items-center gap-3" textClassName="text-3xl font-black tracking-[-0.045em]" /></Link>
