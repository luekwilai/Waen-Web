...
export default function Home(){
 ...
 return <div className="creative-home"><span id="packages" aria-hidden="true" className="creative-home-anchor" /><ParticleBackground/><Motion/><a className="skip-link" href="#main">ข้ามไปเนื้อหา</a>
 <SiteHeader/>
